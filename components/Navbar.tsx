    ...
    <>
      ...
      >
        <div className="max-w-[1500px] mx-auto px-6 md:px-16 flex items-center justify-between">
          ...
          >
            <span
              className={`h-0.5 w-6 bg-black transition-all duration-300 ${isMenuOpen ? "rotate-45 translate-y-2" : ""}`}
            />
            <span
              className={`h-0.5 w-6 bg-black transition-all duration-300 ${isMenuOpen ? "opacity-0" : ""}`}
            />
            <span
              className={`h-0.5 w-6 bg-black transition-all duration-300 ${isMenuOpen ? "-rotate-45 -translate-y-2" : ""}`}
            />
      ...
      <div
        className={`fixed inset-0 bg-white/98 backdrop-blur-3xl z-[115] lg:hidden transition-all duration-500 ease-in-out ${
          isMenuOpen
          ...
          <div className="mt-12 space-y-6">
            ...
            <div className="flex flex-col gap-4 pt-8 border-t border-gray-100">
              ...
              <p className="text-[10px] text-gray-400 text-center leading-relaxed">
                © 2026 United Mississippi Bank. <br /> Sophisticated banking for
                modern life.
              </p>
            </div>
          </div>
